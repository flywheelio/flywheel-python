...
analytics.oauth_client_id = 'CLIENT_ID' # OAuth application ID from flywheel dashboard
analytics.oauth_client_key = privatekey # generated as a public/private key pair in PEM format from OpenSSL
analytics.oauth_key_id = 'KEY_ID' # From flywheel dashboard after uploading public key
