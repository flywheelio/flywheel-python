...
from flywheel.analytics import utils
from flywheel.analytics.request import APIError
from flywheel.analytics.consumer import FatalError
...
class OauthManager(object):
    def __init__(self,
                 ...
                 client_key,
                 key_id,
                 auth_server='https://oauth2.theflywheel.app',
        ...
        self.log = logging.getLogger('flywheel')
        self.thread = None
