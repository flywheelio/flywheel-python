...
from flywheel.analytics.request import APIError
...
class TestConsumer(unittest.TestCase):
    ...
    def test_upload_interval(self):
        ...
        with mock.patch('flywheel.analytics.consumer.post') as mock_post:
            consumer.start()
            for i in range(0, 3):
                track = {
                    'type': 'track',
    ...
    def _test_request_retry(self, consumer,
        ...
        with mock.patch('flywheel.analytics.consumer.post',
    ...
    def test_max_batch_size(self):
        ...
        with mock.patch('flywheel.analytics.request._session.post',
